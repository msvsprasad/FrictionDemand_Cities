%%%%%%%%%%%%%%%%% script_estimateAccelForTrafficTrajSCE.m %%%%%%%%%%%%%%%%%
%% Purpose:
...
dummy_enu_reference_id = 3; % Just a dummy for SCE
dummy_traffic_id = 1;
simulink_trip_id = 701;
...
if flag.dbQuery
    ...
    list_of_vehicleIds = [7308; 7511; 5007; 295];
...
for index_vehicle = 1:numel(list_of_vehicleIds)
    ...
    if flag.dbInsert
        ...
        friction_measurement.cg_latitude  = raw_trajectory.latitude;
        friction_measurement.cg_longitude = raw_trajectory.longitude;
