function [dydt,normal_force,tire_force] = fcn_VD_dt7dofModelForController(t,y,steering_angle,wheel_torque,...
...
omega = y(4:7); % angular velocity of wheels [rad/s]
pose  = y(8:10); % position and orientation of the vehicle
...
%% Newtonian Dynamics
acceleration = fcn_VD_dt7dofForceEquation(tire_force,wheel_torque,...
    steering_angle,vehicle,road_properties);
DvelDt = fcn_VD_7dofStateEquation(t,y(1:7),acceleration);
if flag_update
