function fcn_pushElevationDataToROIdb(input_table_push_data)
%% ------------------------ CONNECT TO DATABASE ------------------------ %%
% Database parameters
...
db_tablename = 'road_traffic_extend_2_matlab';  % relation name
% insert data into the table
sqlwrite(conn, db_tablename, input_table_push_data);
