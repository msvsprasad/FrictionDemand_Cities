...
% 
% INPUTS:
%   path1: the first reference path you wan't to calculate yaw for
%   path2: the second reference path you wan't to calculate yaw for
%   path3: the third reference path you wan't to calculate yaw for
%   path4: the fourth reference path you wan't to calculate yaw for
% 
% OUTPUTS:
%   path1_yaw: Nx1 array
%   path2_yaw: Nx1 array
