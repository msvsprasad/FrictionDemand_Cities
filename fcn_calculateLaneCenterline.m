...
function [LCL_lane1, LCL_lane2, LCL_lane3, LCL_lane4] = fcn_calculateLaneCenterline(reference_traversal,number_of_lanes)
...
% Initialize lane variables
LCL_lane1 = []; LCL_lane2 = []; LCL_lane3 = []; LCL_lane4 = [];
% set input variables for offset_traversal function
if number_of_lanes == 1
    % the RCL is the LCL, do not need to calculate an offset
    ...
    LCL_lane1 = [LCL_lane1_path...
        LCL_lane1_yaw,...
        reference_traversal.Station...
        lane1*ones(numel(reference_traversal.X),1)];
...
elseif number_of_lanes == 2
    ...
    LCL_lane1 = [LCL_lane1_path...
        LCL_lane1_yaw,...
        offset_traversals.traversal{1,1}.Station...
        lane1*ones(numel(offset_traversals.traversal{1,1}.X),1)];

    % Lane 2
    LCL_lane2 = [LCL_lane2_path...
        LCL_lane2_yaw,...
        offset_traversals.traversal{1,2}.Station...
        lane2*ones(numel(offset_traversals.traversal{1,2}.X),1)];
...
elseif number_of_lanes == 3
    ...
    LCL_lane2 = [LCL_lane2_path...
        LCL_lane2_yaw,...
        reference_traversal.Station...
        lane2*ones(numel(reference_traversal.X),1)];

    % Lane 3
    LCL_lane3 = [LCL_lane3_path...
        LCL_lane3_yaw,...
        offset_traversals.traversal{1,2}.Station...
        lane3*ones(numel(offset_traversals.traversal{1,2}.X),1)];
...
elseif number_of_lanes == 4
    ...
    LCL_lane3 = [LCL_lane3_path...
        LCL_lane3_yaw,...
        offset_traversals.traversal{1,3}.Station...
        lane3*ones(numel(offset_traversals.traversal{1,3}.X),1)];

    % Lane 4
    LCL_lane4 = [LCL_lane4_path...
        LCL_lane4_yaw,...
        offset_traversals.traversal{1,4}.Station...
        lane4*ones(numel(offset_traversals.traversal{1,4}.X),1)];
end
end